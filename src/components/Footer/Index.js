            ...
            <footer className="footer">
              <div className="wrapper">
                <p className="footer__copy">
                        <Link className="footer__owner" to="/">{this.props.author}</Link>&nbsp;<span role="img" aria-label="Smiling Face with Sunglasses">😎</span> - Desarrollado con&nbsp; 
                        <a className="footer__tech" target="_blank" rel="noreferrer" href="https://reactjs.org/">reactjs</a> y <a className="footer__tech" target="_blank" rel="noreferrer" href="https://gatsbyjs.org/">gatsbyjs</a></p>
